...
class DomSQL {
    ...
    /**
     * @public
     * @name DomSQLDescription
     *
     * @example *
     * @example * Now internet has definable logics.
     * @example * It is based on one of my firs open source projects - called DomSQL (domsql.sf.net).
     * @example * Everything you like on the Internet in one place in a way you like it.
     * @example * The 'content' is the king of the Internet. You are the king here,
     * @example * you say how the content is shown.
     * @example * You can relate or apply logics, keep history, keep track of the changes to
     * @example * any piece of information out there in a very easy way
     * @example * yes, this is SQL for the WEB. Well, in some sense this is the first antisocial network.
     * @example *
     */
    doc(){}
